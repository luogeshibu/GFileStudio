...
<h3>连接点修复（复选框）</h3>
<p>勾选“修复连接点（补齐 node_area / link）”后，再点击“开始基础处理”，程序会先识别已验证刀闸、负荷开关和断路器的真实端口，仅沿 X 方向对齐设备，并同步调整直接连接线端点；随后补齐、修正或清理 node_area 与 link，使红色空心点恢复为绿色连接点。不勾选时完全跳过。该操作不修改设备 Y、ID、文字、颜色、图标、Merge、画布或其他业务属性。</p>
<h3>线路与母线颜色</h3>
...
<h3>推荐流程</h3>
<ol>
<li>先在“基础处理”中完成通用规则、重复 ID、环网柜和颜色处理。</li>
