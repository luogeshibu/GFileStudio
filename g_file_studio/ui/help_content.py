...
<p><b>ID 功能：</b>已从基础处理抽离到独立“ID 规则模板”页面。</p>
<h3>环网柜图元处理</h3>
...
""",
    ...
    "id_rules": (
        ...
        """
<h3>唯一规则来源</h3>
<p>本模块只管理 XML 元素的 id，不读取、不修改 Alias。每一种元素类型只能使用人工确认的“固定数字前缀 + 固定总位数”规则。</p>
<h3>扫描当前 G</h3>
...
<h3>主母线合并</h3>
<ul>
<li>勾选“合并主母线为一条”后，仅处理所有馈线已经对齐的最顶部非零长度水平 &lt;Bus&gt;。</li>
...
<h3>推荐流程</h3>
<ol>
<li>先在“ID 规则模板”中确认元素 ID 规则并按需检查/修复重复 ID，再在“基础处理”中完成通用规则、环网柜、图元升级和颜色处理。</li>
