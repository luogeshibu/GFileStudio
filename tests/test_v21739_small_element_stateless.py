...
def test_version_21739():
    assert '__version__ = "2.17.41"' in Path('g_file_studio/__init__.py').read_text(encoding='utf-8')
    assert 'version = "2.17.41"' in Path('pyproject.toml').read_text(encoding='utf-8')
