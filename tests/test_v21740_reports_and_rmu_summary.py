...
def test_version_21740():
    assert '__version__ = "2.18.16"' in Path('g_file_studio/__init__.py').read_text(encoding='utf-8')
    assert 'version = "2.18.16"' in Path('pyproject.toml').read_text(encoding='utf-8')
